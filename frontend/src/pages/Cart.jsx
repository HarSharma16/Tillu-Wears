      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button onClick={()=>navigate('/place-order')} className='bg-black text-white text-sm my-8 px-8 py-3 rounded hover:bg-gray-500 transition-colors duration-50 active:bg-gray-900'>
              PROCEED TO CHECKOUT
            </button>
          </div>
        </div>
