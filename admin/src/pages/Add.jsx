...
// Removed invalid mongoose import
...
const Add = ({token}) => {
  ...
  formData.append("bestseller", bestseller === true || bestseller === "true" ? "true" : "false")
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-4'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-2 py-2 border border-gray-300 rounded' type="text" placeholder='Enter product name' required/>
      </div>
      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-2 py-2 border border-gray-300 rounded' placeholder='Enter product description' required/>
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price} type='number' placeholder='25' className='w-full sm:w-[120px] px-3 py-2 border border-gray-300 rounded' />
        </div>
      </div>
  ...
  <input onChange={() => setBestseller(prev => !prev)} checked={bestseller === true || bestseller === "true"} type="checkbox" id="bestseller" />
